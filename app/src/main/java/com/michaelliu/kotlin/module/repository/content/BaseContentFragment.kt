...
import kotlinx.android.synthetic.main.fragment_content_repository.recyclerview
import kotlinx.android.synthetic.main.fragment_content_repository.refresh_layout
...
abstract class BaseContentFragment : LazyLoadFragment<IRepositoryView, IRepositoryPresenter>(), IRepositoryView, OnLoadingMoreListener {
  ...
  var mCondition: RepositoryCondition = RepositoryCondition()
  var mItems: ArrayList<RepositoryModel.RepositoryItem> = ArrayList()
